import torch
from utils.model import ResNet9  # Uses your exact model class structure

# 1. Define your model setup
...
# 3. Create a dummy image tensor (1 batch, 3 color channels, 256x256 size) to chart the graph
